...
def _visit_page(url: str): 
    ...
    try:
        ...
        try:
            # Use "domcontentloaded" instead of "networkidle" to avoid hanging on pages with continuous network activity
            page.wait_for_load_state("domcontentloaded", timeout=10000)
        except Exception:
            pass  # Continue even if timeout - page may be usable
