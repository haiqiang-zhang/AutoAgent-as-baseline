...
def run_python(
    ...
    Args:
        ...
        timeout: The maximum time in seconds to wait for the script to complete. Default is 60 seconds. (Optional)
    Returns:
    ...
    try:
        ...
        result = env.run_command(command, print_stream, timeout=timeout)
        return result
